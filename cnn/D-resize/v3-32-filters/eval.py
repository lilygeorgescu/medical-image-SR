...
def compute_performance_indeces(test_path, test_images_gt, test_images_1_2, test_images_2_1, checkpoint, add_to_summary=True):
    ...
    if test_path.find('test') != -1 and add_to_summary:
        ...
        writer = tf.summary.FileWriter('train.log') 
...
test_images_gt, test_images_1_2, test_images_2_1 = read_images(train_path)
...
for i in range(0,  4):
    ...
    compute_performance_indeces(train_path, test_images_gt, test_images_1_2, test_images_2_1, checkpoint) 
