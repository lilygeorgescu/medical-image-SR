...
def read_all_directory_images_from_directory_as_list(directory_path, add_to_path=''):
    '''
...
def read_images_depth_training(directory_path, add_to_path=''): 
    image_3d_list, min_H_W, min_D = read_all_directory_images_from_directory_as_list(directory_path, add_to_path)
    images_list = []
    for image_3d in image_3d_list:
        image_3d = np.transpose(image_3d, [1, 2, 0, 3])
        images_list.append(image_3d)
    
    return images_list, min_H_W, min_D
    
def read_images_depth_training_2(directory_path, add_to_path=''): 
    image_3d_list, min_H_W, min_D = read_all_directory_images_from_directory_as_list(directory_path, add_to_path)
    images_list = []
    for image_3d in image_3d_list:
        image_3d = np.transpose(image_3d, [2, 1, 0, 3])
        images_list.append(image_3d)
