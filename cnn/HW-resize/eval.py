...
def run_network(images, ground_truth, checkpoint_name):
    ...
    with tf.Session(config=config) as sess:    
        ...
        output_ = sess.run(output, feed_dict={input: images , target: ground_truth})   
        ...
        cost = sess.run(loss, feed_dict={output_3d_rezised_ph: output_3d_rezised, target: ground_truth})
