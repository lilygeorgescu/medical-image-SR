...
checkpoint = os.path.join(params.folder_data, 'model.ckpt%d' % 129)
eval_images_gt, eval_images = read_images(test_path)
...
compute_performance_indeces(test_path, eval_images_gt, eval_images,  checkpoint)  
